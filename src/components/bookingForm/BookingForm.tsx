  ...
  const onHandleSubmit: SubmitHandler<BookingSchema> = async (data) => {
    const bookingToSend: BookingToSendInterface = {
      guest: {
        ...
        img: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=400&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      },
